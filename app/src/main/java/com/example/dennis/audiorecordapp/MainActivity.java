...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_playLast.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //Zum ABspielen der letzten Audio-Datei wird ein MediaPlayer benötigt
                mediaPlayer = new MediaPlayer();
                try{
                    //Pfad der AudioDatei wird an den MediaPlayer übergeben
    ...
    //Dem Mediarecorder wird das benötigte Mikrofon des Devices übermittelt
    //Außerdem wird das Format der AudioDatei festgelegt
    //sowie der Pfad wo die Datei dann abgespeichert werden soll
    ...
    //Es wird eine Bestätigung des Nutzers benötigt um Dateien auf dem Gerät abzuspeichern
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        switch(requestCode)
        {
            case RequestPermissionCode:
                ...
                {
                    //es wird überprüft ob der Nutzer den benötigten Zugriff bestätigt hat
